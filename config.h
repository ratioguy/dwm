...
static const Key keys[] = {
	...
	{ MODKEY,			XK_o,	   spawn,     	   SHCMD("pactl set-default-sink alsa_output.usb-HP_HP_Speaker_Bar-00.analog-stereo ; killall easyeffects ; notify-send -t 8000 'Output: External Speaker'") },
	{ MODKEY|ShiftMask,		XK_o,	   spawn,     	   SHCMD("pactl set-default-sink alsa_output.pci-0000_00_1f.3.analog-stereo ; killall easyeffects ; notify-send -t 8000 'Output: Internal Speaker'") },
	{ MODKEY|Mod1Mask,		XK_o,	   spawn,     	   SHCMD("pactl set-default-sink alsa_output.usb-Yichip_USB-Audio-1.0-00.analog-stereo ; setsid -f easyeffects --gapplication-service ; notify-send -t 8000 'Output: Headphones'") },
	...
	{ MODKEY,	        	XK_z,	   spawn,     	   SHCMD("bash ~/.local/bin/screenshot.sh select") },
	{ MODKEY|ShiftMask,		XK_z,	   spawn,     	   SHCMD("bash ~/.local/bin/screenshot.sh focused") },
	...
	{ MODKEY|ShiftMask,		XK_p,	   spawn,  SHCMD("~/.local/bin/monitor.sh") },
